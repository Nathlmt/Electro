                ...
                <div class="row">
                    <div class="col-md-6 center-block">
                        <form action="LoginServlet" method="post" class="billing-details">
                            ...
                            <h5><a href="signup.jsp">Register?</a></h5>
                            <h5><a href="resetpassword.jsp">Forget Password?</a></h5>
                            <button type="submit" value="signin" class="primary-btn order-submit">Sign in</button>
                        </form>
